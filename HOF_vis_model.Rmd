...
- About 570 members of the Baseball Writers Association of America vote each year in December, with results announced in January
- You must appear on at least 75% of the ballots to be elected
- Sometime in the 1960s they started to enforce the rule that if you appear on less than 5% of ballots, you are permanently removed from future ballots.
...
```{r graphics, message=FALSE, fig.cap='A scatterplot of `cars`', out.width=500}
